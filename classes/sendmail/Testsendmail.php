...
/* FUNCTIONS TO SET THE DATA */
	...
	function setTextMessage ($text_message) { $this->text_message = $text_message; echo "ttttxtmsg::".$this->text_message;}
	...
	**/
	public function send () {
            echo 'inside send fun()::'.$this->text_message;
		$to = array (
		...
		echo "to:".var_dump($to);
                echo"txtmsg::".$this->text_message;
                echo "html msg::".$this->html_message;echo"end:::";
...
// BEGIN HTML MESSAGE -----------------------------------------------------------------------------------------------------------
			case 1:
                                echo "case 1:msg::".$txt_msg;
				$total_msg = "{$txt_msg}\n\n\n";
				$total_msg .= "".strip_tags ($this->footer);
                                echo "ENENENEND::::".$total_msg;
				break;
