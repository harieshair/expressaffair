...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="#" title="Kartconnect.com">
            	<img style="width:250px;" src="img/logo.png" alt="UX - Coming Soon HTML Template">
            </a>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
		...
		<section class="newsletter row fade-down">      
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="contact col-md-6 fade-down validate" target="_blank" novalidate>
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; Kartconnect.com 2015, All Rights Reserved.</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="rinkumohanty@live.com"; // Add your e-mail here
        	if($code!=$captcha){
