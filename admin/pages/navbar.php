    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="home.php" class="navbar-brand"><b>Event</b> Management</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse1">
          <ul class="nav navbar-nav">
            <li>               <a href="javascript:void(0);" onclick="getcontents('pages/events/events.php','right-content')" >Manage</a>  
              ...
              <li >  <a href="javascript:void(0);" onclick="getcontents('pages/configs/customers','right-content')">Customers</a>                </li>
