              ...
              <div class="box box-primary">
                <div class="box-body"> 
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group margin">
                        <a class="btn btn-flat bg-orange  form-control"  href="javascript:void(0);"  id="btn_selectservice" onclick="selectEventServices();" selectedservice="" >
                          <i class="fa fa-list"></i>Choose your services</a>
