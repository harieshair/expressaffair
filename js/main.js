...
function getcatalogname() {
    ...
    oncallservice(postdata, "http://develop.expressaffair.com/affairservice/getCatalogsByMaterName", function () {
        getcontentresponse()
    });
}
...
function callRestService(serviceName, postdata, callback) {
    oncallservice(postdata, "http://localhost/expressaffair/affairservice/" + serviceName, function () {
        callback()
    });
}
